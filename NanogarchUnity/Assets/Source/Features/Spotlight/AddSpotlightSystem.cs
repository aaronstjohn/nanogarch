...
public sealed class AddSpotlightSystem : ReactiveSystem {

    readonly Contexts _contexts;
    public AddSpotlightSystem(Contexts contexts) : base(contexts.core) {
        _contexts = contexts;
    
    }
    protected override Collector GetTrigger(Context context) {
        return context.CreateCollector(CoreMatcher.InSpotlight,GroupEvent.Added);
    }
