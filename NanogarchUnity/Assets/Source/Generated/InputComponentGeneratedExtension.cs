...
namespace Entitas {
    ...
    public partial class Entity {
        ...
        public Entity AddInput(UnityEngine.Vector3 newInputPos, string newTargetName) {
            var component = CreateComponent<InputComponent>(InputComponentIds.Input);
            component.inputPos = newInputPos;
            component.targetName = newTargetName;
            return AddComponent(InputComponentIds.Input, component);
        }

        public Entity ReplaceInput(UnityEngine.Vector3 newInputPos, string newTargetName) {
            var component = CreateComponent<InputComponent>(InputComponentIds.Input);
            component.inputPos = newInputPos;
            component.targetName = newTargetName;
