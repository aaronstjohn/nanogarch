...
public class SphericalCoordinates  {
	...
	// public Vector3 r_hat()
	// {
	// 	return new Vector3( Mathf.cos(polar)*Mathf.sin(elevation),
	// 				Mathf.sin(elevation)*Mathf.sin(polar),
	// 				Mathf.cos(elevation));
	// }
	// public Vector3 polar_hat()
	// {
	// 	return new Vector3(-Mathf.sin(polar),Mathf.cos(polar),0);
	// }
	// public Vector3 elevation_hat()
	// {
	// 	return new Vector3(Mathf.cos(polar)*Mathf.cos(elevation),
	// 					   Mathf.sin(polar)*Mathf.cos(elevation),
	// 					   -Mathf.sin(elevation));
	// }
	// public static SphericalCoordinates Subtract(SphericalCoordinates a, SphericalCoordinates b)
	// {
	// 	Vector3 a_cart = new Vector3();
	// 	Vector3 b_cart = new Vector3();
	// 	SphericalToCartesian(a.radius, a.polar, a.elevation, out a_cart);
	// 	SphericalToCartesian(b.radius, b.polar, b.elevation, out b_cart);
	// 	return 
	// }
	/// <summary>
